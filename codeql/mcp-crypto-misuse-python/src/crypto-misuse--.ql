...
// -----------------------------------------------------------
// 最终 select：对应你 Excel 里的 Summary 列
// -----------------------------------------------------------
...
select e,
  msg,
  "Rule: " + ruleId + " | EvidenceKey: " + evKey + " | EvidenceMatch: " + evMatch
